...
import CustomerMapperImplementation from '../mapper/customer-mapper-implementation';
...
describe('Customer repository test', () => {
  ...
  it('should create a customer', async () => {
    const customerRepository: CustomerRepositoryInterface = new CustomerRepository(mapper);
